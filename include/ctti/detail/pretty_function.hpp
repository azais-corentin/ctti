...
template <typename T> constexpr ctti::detail::cstring type() { return {CTTI_PRETTY_FUNCTION}; }

template <typename T, T Value> constexpr ctti::detail::cstring value() { return {CTTI_PRETTY_FUNCTION}; }
